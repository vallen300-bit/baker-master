...
# Fable 5 = $10/$50 per MTok (GA 2026-06-09); Opus 4.x = $5/$25.
# Constant names stay for _compute_cost_usd; mixed Step-5-only overrides
# are deliberately out of scope because production runs one model fleet-wide.
