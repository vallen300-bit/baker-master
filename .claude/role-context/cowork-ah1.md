...
Canonical baker memory: ~/baker-vault/_ops/agents/aihead1/{PINNED.md,operating.md,ARCHIVE.md} — SHARED with lead. Read on session start.
...
Both instances:
- Auto-load PINNED.md at session start (Director ratified 2026-05-17).
...
1. Read `~/baker-vault/_ops/agents/aihead1/PINNED.md` (current state across both AH1 instances).
2. Read latest handover in `~/.claude/projects/-Users-dimitry-bm-aihead1/memory/MEMORY.md` (the Terminal AH1's session-handover trail — your shared institutional memory).
