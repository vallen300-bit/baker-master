...
# ─────────────────────────────────────────────────────────────────────────────
for spec in "n:CM-1" "o:CM-2" "p:CM-3" "q:CM-4" "r:hag-filer" "s:codex" "t:clerk" "u:codex-arch" "v:clerk-haiku" "w:baden-baden-desk" "x:movie-desk" "y:librarian" "z:the-fund"; do
  CASE_LABEL="${spec%%:*}"
  CASE_SLUG="${spec##*:}"
...
echo ""
echo "All forge snapshot cases PASS."
