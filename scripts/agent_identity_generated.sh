...
# SHA256: 458f6d88253d9a0aaacd4a2b42d2b007e24e156baafa0eacf708e2688ffda46a
...
AGENT_IDENTITY_BUS_AGENT_SLUGS=(lead cowork-ah1 deputy deputy-codex cortex aid b1 b2 b3 b4 researcher codex codex-arch clerk clerk-haiku russo-ai deep55 ben hag-desk origination-desk ao-desk movie-desk baden-baden-desk CM-1 CM-2 CM-3 CM-4 hag-filer)
AGENT_IDENTITY_VALID_SLUGS=(director daemon dispatcher lead cowork-ah1 deputy deputy-codex cortex aid b1 b2 b3 b4 researcher codex codex-arch clerk clerk-haiku russo-ai deep55 ben hag-desk origination-desk ao-desk movie-desk baden-baden-desk CM-1 CM-2 CM-3 CM-4 hag-filer)
...
agent_identity_is_valid_slug() {
  case "${1:-}" in
    director|daemon|dispatcher|lead|cowork-ah1|deputy|deputy-codex|cortex|aid|b1|b2|b3|b4|researcher|codex|codex-arch|clerk|clerk-haiku|russo-ai|deep55|ben|hag-desk|origination-desk|ao-desk|movie-desk|baden-baden-desk|CM-1|CM-2|CM-3|CM-4|hag-filer) return 0 ;;
    *) return 1 ;;
  esac
}
