...
# SHA256: 7fdcdd86c164b3da34446b816ff44d301f0b09a7115937f341f594cb68873061
...
AGENT_IDENTITY_BUS_AGENT_SLUGS=(lead cowork-ah1 deputy deputy-codex cortex aid b1 b2 b3 b4 researcher codex codex-arch clerk clerk-haiku hag-desk origination-desk ao-desk CM-1 CM-2 CM-3 CM-4 hag-filer)
AGENT_IDENTITY_VALID_SLUGS=(director daemon lead cowork-ah1 deputy deputy-codex cortex aid b1 b2 b3 b4 researcher codex codex-arch clerk clerk-haiku hag-desk origination-desk ao-desk CM-1 CM-2 CM-3 CM-4 hag-filer)
...
agent_identity_is_valid_slug() {
  case "${1:-}" in
    director|daemon|lead|cowork-ah1|deputy|deputy-codex|cortex|aid|b1|b2|b3|b4|researcher|codex|codex-arch|clerk|clerk-haiku|hag-desk|origination-desk|ao-desk|CM-1|CM-2|CM-3|CM-4|hag-filer) return 0 ;;
    *) return 1 ;;
  esac
}
