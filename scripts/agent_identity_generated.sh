...
# SHA256: 01ac711a8b171b99e58395d0420a8c48ba88632663ae968dc95af872040a7595
...
AGENT_IDENTITY_BUS_AGENT_SLUGS=(lead cowork-ah1 deputy deputy-codex cortex aid b1 b2 b3 b4 researcher codex codex-arch clerk clerk-haiku russo-ai deep55 hag-desk origination-desk ao-desk CM-1 CM-2 CM-3 CM-4 hag-filer)
AGENT_IDENTITY_VALID_SLUGS=(director daemon lead cowork-ah1 deputy deputy-codex cortex aid b1 b2 b3 b4 researcher codex codex-arch clerk clerk-haiku russo-ai deep55 hag-desk origination-desk ao-desk CM-1 CM-2 CM-3 CM-4 hag-filer)
...
agent_identity_is_valid_slug() {
  case "${1:-}" in
    director|daemon|lead|cowork-ah1|deputy|deputy-codex|cortex|aid|b1|b2|b3|b4|researcher|codex|codex-arch|clerk|clerk-haiku|russo-ai|deep55|hag-desk|origination-desk|ao-desk|CM-1|CM-2|CM-3|CM-4|hag-filer) return 0 ;;
    *) return 1 ;;
  esac
}
