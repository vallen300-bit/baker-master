...
## What's done
- ACK'd #11256 + #11260. Pulled brief on main. Branch cut b4/grok-4-5-week-trial.
- Recon complete (see below). grok-4.5 pricing VERIFIED via official xAI docs: $2.00/M in, $6.00/M out; model id exactly `grok-4.5`.
