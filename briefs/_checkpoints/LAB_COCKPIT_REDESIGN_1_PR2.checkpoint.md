...
- [x] D5 amber predicate + amber class (88be91c7/8b7f174d)
- [x] D5 unacked_messages field + panel render
- [x] D6 wake verb + guards + dedupe + audit + openTerm call
- [x] tests: 52 cockpit pass incl test_cockpit_wake.py + amberState node test
- [ ] verify live :7800 AC-1..AC-7 POST-MERGE (deploy from merged main); wake drill on real seat
